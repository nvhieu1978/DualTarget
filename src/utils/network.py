...
blockfrost_project_id = os.getenv("preview0zkKyyt1OgyY2PweIYbbSXlUEKQHta2D", None)

network_name = os.getenv("NETWORK", "preprod")#"preview")
...
def get_chain_context() -> ChainContext:
    ...
    if chain_backend == "ogmios":
        ...
        #return BlockFrostChainContext("preview0zkKyyt1OgyY2PweIYbbSXlUEKQHta2D", base_url="https://cardano-preview.blockfrost.io/api/")
        return BlockFrostChainContext("preprod2EkL4jB7Awsl1ugTeMg1oOID9gHLi6pd", base_url="https://cardano-preprod.blockfrost.io/api/")
    else:
